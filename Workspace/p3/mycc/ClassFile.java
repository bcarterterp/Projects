...
public class ClassFile implements Constants
{
   ...
   public ClassFile(String cname)
   {
      try
      {
         ...
         verboseFlag = false;        // print out more diagnostics
...
//----------------------------------------------------
//----------------------------------------------------
//--- Modify code past this point for project 
//----------------------------------------------------
//----------------------------------------------------
...
//       System.out.println(s.name()+": MaxStack="+mgen.getMaxStack()+
//                                  " MaxLocals="+mgen.getMaxLocals());
   ...
   */
   ...
   private static void optimizeCode(InstructionList il)
   {
