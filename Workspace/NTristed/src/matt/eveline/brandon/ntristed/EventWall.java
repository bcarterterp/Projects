...
public class EventWall extends Activity {
	...
	private void setupWall() {
		...
		if(more_info.size() == 0 || more_info == null){
			nothing = new TextView(this);
			nothing.setText("There are no events in your area from those Handles :(");
			wall.addView(nothing);
			nothing.setTextSize(30);
