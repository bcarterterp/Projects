...
public class LetterBag {
	...
	public char replaceTile(char old_tile) {

		tile_set[Character.getNumericValue(old_tile-ASCII_OFFSET)]++;
		return getTile();
	...
	public int getPoints(int letter) {

		System.out.println(letter);
		return tile_points[letter-ASCII_OFFSET];
...
public char getCons(){
	...
	public boolean isUniq(char hand[],char letter){
